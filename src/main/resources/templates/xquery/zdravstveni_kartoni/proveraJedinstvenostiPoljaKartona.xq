...
return if ($karton/@jmbg = "%1$s") then "JMBG nije jedinstven! " else "";
...
return if ($karton/@broj_zdr_knjizice = "%2$s") then "Broj zdrastvene knjizice nije jedinstven! " else "";
...
return if ($karton/@broj_kartona = "%3$s") then "Broj zdrastvenog kartona nije jedinstven! " else "";
...
return if ($karton/@lbo = "%4$s") then "Broj licne karte nije jedinstven! " else "";
