...
@XmlRootElement(name = "izbor_promena_lekara", namespace = "http://zis.rs/zis/seme/Izbor_promena_lekara")
public class IzborPromenaLekara {

    @XmlElement(name = "naziv_ustanove", namespace = "http://zis.rs/zis/seme/Izbor_promena_lekara", required = true)
    protected String nazivUstanove;
    @XmlElement(name = "tip_obrasca", namespace = "http://zis.rs/zis/seme/Izbor_promena_lekara", required = true, defaultValue = "izbor")
    protected String tipObrasca;
    @XmlElement(name = "razlog_promene", namespace = "http://zis.rs/zis/seme/Izbor_promena_lekara", required = true, defaultValue = "ne_radi")
    protected String razlogPromene;
    @XmlElement(name = "ustanova_proslog_lekara", namespace = "http://zis.rs/zis/seme/Izbor_promena_lekara", required = true)
    protected String ustanovaProslogLekara;
    @XmlElement(name = "prosli_lekar", namespace = "http://zis.rs/zis/seme/Izbor_promena_lekara", required = true)
    protected IzborPromenaLekara.ProsliLekar prosliLekar;
    @XmlElement(namespace = "http://zis.rs/zis/seme/Izbor_promena_lekara", required = true)
