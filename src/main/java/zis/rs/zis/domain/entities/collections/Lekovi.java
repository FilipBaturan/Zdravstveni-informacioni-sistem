 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://zis.rs/zis/seme/lek}lek" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "lekovi", namespace = "http://zis.rs/zis/seme/lekovi")
public class Lekovi {

    @XmlElement(namespace = "http://zis.rs/zis/seme/lek")
    ...
    public void setLek(List<Lek> lek) {
        this.lek = lek;
    }
}
