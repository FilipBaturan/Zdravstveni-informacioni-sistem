 ...
 *             &lt;complexContent&gt;
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;attribute ref="{http://localhost:8080/zis/seme/lekar}identifkator use="required""/&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
 *         &lt;/element&gt;
...
@XmlRootElement(name = "lekar", namespace = "http://localhost:8080/zis/seme/lekar")
public class Lekar {

    @XmlElement(namespace = "http://localhost:8080/zis/seme/lekar", required = true)
    protected Lekar.Korisnik korisnik;
    @XmlElement(namespace = "http://localhost:8080/zis/seme/lekar", required = true, defaultValue = "ospta_praksa")
    protected String tip;
    @XmlElement(name = "oblast_zastite", namespace = "http://localhost:8080/zis/seme/lekar", required = true)
    ...
    public static class Korisnik {
        ...
        @XmlAttribute(name = "identifkator", namespace = "http://localhost:8080/zis/seme/lekar", required = true)
        @XmlSchemaType(name = "anyURI")
